...
export const artworks: Artwork[] = [
  {
    ...
    image: `${BASE}/2020/03/At-The-Bay-1-scaled.jpg`,
    price: 4800,
    available: true,
    featured: true,
  ...
  },
  {
    ...
    dimensions: '24" × 36"',
    series: 'Urban Series',
    image: `${BASE}/2020/03/Indigo-Series.jpg`,
    price: 3200,
    available: true,
    featured: true,
  ...
  },
  {
    ...
    image: `${BASE}/2020/03/Ocean-Song.jpg`,
    price: 7200,
    available: false,
    featured: true,
  ...
  },
  {
    ...
    dimensions: '20" × 20"',
    series: 'Coastal Series',
    image: `${BASE}/2020/03/Emerald-Shores.jpg`,
    price: 2400,
    available: true,
    featured: false,
  },
  {
    ...
    image: `${BASE}/2020/03/Amber-Glow.jpg`,
    price: 3800,
    available: false,
    featured: false,
  },
  {
    ...
    dimensions: '24" × 24"',
    series: 'Coastal Series',
    image: `${BASE}/2020/03/All-That-is-Blue.jpg`,
    price: 2800,
    available: true,
    featured: false,
  },
  {
    ...
    dimensions: '18" × 24"',
    series: 'Dawn Series',
    image: `${BASE}/2020/03/Aurora-Lights.jpg`,
    price: 2100,
    available: true,
    featured: false,
  },
  {
    ...
    medium: 'Reverse acrylic on Plexiglas',
    dimensions: '12" × 16"',
    image: `${BASE}/2020/03/Cerulean.jpg`,
    price: 1400,
    available: true,
    featured: false,
  },
  {
    ...
    image: `${BASE}/2020/03/The-Spirit-of-Red.jpg`,
    price: 3200,
    available: false,
    featured: false,
  },
  {
    ...
    image: `${BASE}/2020/03/Temperature-Rising.jpg`,
    price: 4200,
    available: true,
    featured: false,
  },
